...
En este caso, la ecuaci\'on $x(t)$ nos quedar\'a expresada en t\'erminos de cosenos y senos hiperb\'olicos. Para las condiciones iniciales procedemos como en el caso del oscilador subamortiguado, por lo tanto la ecuaci\'on de movimiento nos queda \textbf{[III]}:
...
Al imponer las condiciones iniciales sobre $x(t)$, la soluci\'on nos queda \textbf{[IV]}:
