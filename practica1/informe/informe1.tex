...
Para obtener las soluciones de dicha ecuacion, se propone una solucion de la forma $x(t) = e^{zt}$, con $z \in \mathbb{C}$.
Reemplazando el $x(t)$ propuesto en (1), se obtiene la siguiente ecuacion cuadratica para $z$:
